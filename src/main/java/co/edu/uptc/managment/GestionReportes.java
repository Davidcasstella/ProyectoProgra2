package co.edu.uptc.managment;

import co.edu.uptc.controlador.crudDonacion;
...
public class GestionReportes {
    ...
    public String generarReporteDonacionesPorMes(int mes, int anio) {
        ...
        try {
            ...
            Files.write(Paths.get("src/main/java/co/edu/uptc/Managment/ReporteDonacionesRecibidasPorMes.txt"),
    ...
    public String generarReporteAnimalesAtendidos() {
        ...
        try {
            ...
            Files.write(Paths.get("src/main/java/co/edu/uptc/Managment/ReporteDeAnimalesAtendidos.txt"),
                        reporte.toString().getBytes());
        } catch (IOException e) {
            e.printStackTrace();
        }
